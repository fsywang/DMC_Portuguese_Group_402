...
# run all analysis
all: data/raw/bank.csv data/clean/bank_train.csv data/clean/bank_test.csv data/clean/bank_train_unprocessed.csv reports/count_of_cat_features.png reports/density_plot.png reports/kendall_corr_matrix.png reports/pearson_corr_matrix.png reports/proportion_of_class.png reports/training_report.csv reports/training_report.png
...
# data preprocessing
data/clean/bank_train.csv data/clean/bank_test.csv data/clean/bank_train_unprocessed.csv: data/raw/bank.csv src/preprocessing.py
